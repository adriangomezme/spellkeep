create or replace function get_collection_stats_quantities(p_collection_id uuid)
...
create or replace function get_collection_stats_value(p_collection_id uuid)
...
grant execute on function get_collection_stats_quantities(uuid) to authenticated;
grant execute on function get_collection_stats_value(uuid) to authenticated;
